const CACHE='andanada12-v12-1-20260630';
self.addEventListener('install',e=>{self.skipWaiting();e.waitUntil(caches.open(CACHE).then(c=>c.addAll(['./','./index.html','./manifest.json','./assets/emoticono.jpg','./assets/escudo-bronce-solo.png']).catch(()=>{})))});
